    ...
    <section id="cars" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">Discover our handpicked selection of premium cars</p>
        </div>
          ...
          {cars.map((car) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">{car.reviews} reviews</p>

                <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-gray-100">
                  <div className="flex items-center space-x-2">
                    <Users className="w-4 h-4 text-gray-400" />
                    <span className="text-sm text-gray-600">{car.specs.seats}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Fuel className="w-4 h-4 text-gray-400" />
                    <span className="text-sm text-gray-600">{car.specs.fuel}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Settings className="w-4 h-4 text-gray-400" />
                    <span className="text-sm text-gray-600">{car.specs.transmission}</span>
                  </div>
                </div>
