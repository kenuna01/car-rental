...
const features = [
  {
    ...
    description:
      "All vehicles are fully insured and verified for your safety and peace of mind.",
  },
  {
    icon: Clock,
    title: "24/7 Availability",
    description:
      "Book anytime, anywhere. Our cars are available round the clock for your convenience.",
  },
  {
    icon: MapPin,
  ...
  },
  {
    ...
    description:
      "Multiple payment options with secure transactions and transparent pricing.",
  },
  {
    icon: Headphones,
  ...
  },
  {
    ...
    description:
      "Competitive rates with no hidden fees. Best value for your money.",
  },
];
