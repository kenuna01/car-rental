      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#list-car" className="text-gray-700 hover:text-blue-600 transition-colors font-medium">
              List Your Car
            </a>
            <button
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 space-y-4 border-t">
            <a href="#cars" className="block text-gray-700 hover:text-blue-600 transition-colors font-medium">
              Browse Cars
            </a>
            <a href="#how-it-works" className="block text-gray-700 hover:text-blue-600 transition-colors font-medium">
              How It Works
            </a>
            <a href="#list-car" className="block text-gray-700 hover:text-blue-600 transition-colors font-medium">
              List Your Car
            </a>
            <button
              onClick={() => onAuthClick('login')}
